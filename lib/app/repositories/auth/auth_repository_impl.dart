...
import 'package:dw9_delivery_app/app/core/exceptions/unauthorized.exception.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<void> register(String name, String email, String password) async {
    try {
      ...
      log("Error ao registrar usuários", error: e, stackTrace: s);
      throw RepositoryException(message: "Error ao registrar usuários.");
    }
  }
}
